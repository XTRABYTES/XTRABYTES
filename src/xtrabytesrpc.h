...
#ifndef _XTRABYTESRPC_H_
#define _XTRABYTESRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // XtraBYtes is not connected
...
/**
 * XtraBYtes RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern json_spirit::Value gettxvouts(const json_spirit::Array& params, bool fHelp);
