...
void XtraBYtesGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/xtrabytes_testnet"));
            setWindowIcon(QIcon(":icons/xtrabytes_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/xtrabytes_testnet"));
#endif
            if(trayIcon)
            {
...
void XtraBYtesGUI::setWalletModel(WalletModel *walletModel)
{
...
void XtraBYtesGUI::createTrayIcon()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void XtraBYtesGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void XtraBYtesGUI::optionsClicked()
{
...
void XtraBYtesGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void XtraBYtesGUI::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void XtraBYtesGUI::changeEvent(QEvent *e)
{
...
void XtraBYtesGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void XtraBYtesGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "which goes to the nodes that process your transaction and helps to support the network.  "
          "Do you want to pay the fee?").arg(
                XtraBYtesUnits::formatWithUnit(XtraBYtesUnits::BTC, nFeeRequired));
...
void XtraBYtesGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(XtraBYtesUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}
...
void XtraBYtesGUI::gotoBlockBrowser()
{
...
void XtraBYtesGUI::gotoStatisticsPage()
{
...
void XtraBYtesGUI::gotoChatPage()
{
...
void XtraBYtesGUI::gotoHistoryPage()
{
...
void XtraBYtesGUI::gotoAddressBookPage()
{
...
void XtraBYtesGUI::gotoReceiveCoinsPage()
{
...
void XtraBYtesGUI::gotoSignMessageTab(QString addr)
{
...
void XtraBYtesGUI::gotoVerifyMessageTab(QString addr)
{
...
void XtraBYtesGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void XtraBYtesGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
void XtraBYtesGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void XtraBYtesGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void XtraBYtesGUI::backupWallet()
{
...
void XtraBYtesGUI::changePassphrase()
{
...
void XtraBYtesGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void XtraBYtesGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void XtraBYtesGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void XtraBYtesGUI::updateStakingIcon()
{
