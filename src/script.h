...
#ifndef H_XTRABYTES_SCRIPT
#define H_XTRABYTES_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CXtraBYtesAddress
 */
...
public:
    ...
    // Pre-version-0.6, XtraBYtes always counted CHECKMULTISIGs
