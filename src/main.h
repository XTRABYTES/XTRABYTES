...
#ifndef XTRABYTES_MAIN_H
#define XTRABYTES_MAIN_H
...
public:
    ...
    */
    ...
    /** Amount of xtrabytess spent by this transaction.
    ...
    /** Amount of xtrabytess coming in to this transaction
    ...
    {
        std::string str;
        str += strprintf("%s", GetHash().ToString().c_str());
        return str;
    }
